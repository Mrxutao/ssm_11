...
<script type="text/javascript">
	/* 	function rps(id){
			localhost.href="user/rpassword.do?id="+id; 
	})*/
</script>
<body>
<!--头部-->
...
<!--时间-->
 ...
 <section class="publicMian ">
     <div class="left">
			...
			<nav>
             <ul class="list">
              <li ><a href="${pageContext.request.contextPath }/bill/billList.do">订单管理</a></li>
              <li><a href="${pageContext.request.contextPath }/provider/providerlist.do">供应商管理</a></li>
              <li><a href="${pageContext.request.contextPath }/user/getuserlist.do">用户管理</a></li>
            <%--   <li><a href="javascript:rps(${user.id })">密码修改</a></li> --%>
          <li><a href="${pageContext.request.contextPath }/user/rpassword.do">密码修改</a></li>
