...
<body>
 		<div class="page-bar">
			<ul class="page-num-ul clearfix">
				<li>共${totalCount}条记录&nbsp;&nbsp; ${index }/${pageCount}页</li>
				<c:if test="${index> 1}">
					<a href="javascript:page_nav(document.forms[0],1);">首页</a>
					<a href="javascript:page_nav(document.forms[0],${index-1});">上一页</a>
				</c:if>
				<c:if test="${index< pageCount}">
					<a href="javascript:page_nav(document.forms[0],${index+1});">下一页</a>
